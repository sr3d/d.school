...
get_header(); // Loads the header.php template. ?>
	...
	<div id="content">
		...
		<div class="hfeed">
			...
			<blockquote class="feature-quote">The latest news from the d.School</blockquote>
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
						...
						<?php foreach((get_the_category()) as $category) { echo '<li><a href="' . get_bloginfo('url') . '/blog/category/' . $category->category_nicename . '/" >' . $category->cat_name . '</a></li>'; } ?>
						</ul>
